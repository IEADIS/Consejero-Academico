...
'Regression Training ...'
reg.models <- regress.bestModel.train(allData = data.grades,asignatures = subjects.consider)
reg.models <- Filter(length,reg.models) # EMPTY MODELS REMOVED
'Classification Training ...'
cla.models <- classif.bestModel.train(allData = data.grades,asignatures = subjects.consider)
